          ...
          <div className="space-y-8 animate-fade-in-right">
            ...
            <div data-aos="fade-right" className="space-y-6 leading-relaxed text-slate-300">
              <p className="text-lg animate-fade-in-up" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>
                I'm a <span className="px-2 py-1 font-semibold rounded-md text-themeSecondary ">web developer</span> who loves solving problems with clean and efficient code. I quickly pick up new technologies and enjoy working with teams to improve projects using modern frameworks.
              </p>
              
              <p className="text-lg animate-fade-in-up" style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>
                My focus is on building <span className="px-2 py-1 font-semibold rounded-md text-themeSecondary">user-friendly and high-performance applications</span> that meet real-world needs. I'm always looking to improve my skills through coding challenges and hands-on projects.
              </p>
            </div>
